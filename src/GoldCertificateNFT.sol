...
contract GoldCertificateNFT is ERC721Enumerable, AccessControl, Pausable, ReentrancyGuard {
    ...
    function burn(uint256 tokenId) external onlyRole(MINTER_ROLE) nonReentrant {
